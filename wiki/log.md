...
Append-only change log. Entry format: `## [YYYY-MM-DD] <op> | <summary>`
with ops create/ingest/update/lint/prune. New entries at the bottom.

## [2026-07-26] create | Wiki scaffolded: schema.md, index.md, log.md, wikilint.py (gax-dav)
