...
type: gax/doc
title: GAX test
source: https://docs.google.com/document/d/1DofO8emfHx8bhENkw23hQRj2T6pizH1X7Isq7uHH5f0/edit
time: 2026-04-10T10:05:29Z
tab: e2e_rich_formatting
---
# Project Evaluation Report

*Template for structured assessments*
See [evaluation guidelines](https://example.com/guidelines) for details.
...
> Cost per run = provisioned time x (compute rate + service rate)
